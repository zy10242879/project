                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                                ...
                                if (Yii::$app->session->hasFlash('info')) {
                                    echo '<h5 style="color:red">'.Yii::$app->session->getFlash('info').'--检查错误</h5><br />';
                                }
                                ...
                                echo $form->field($model, 'is_hot')->radioList([0 => '不热卖', 1 => '热卖'], ['class' => 'span8','value'=>0]);
                                echo $form->field($model, 'is_sale')->radioList(['不促销', '促销'], ['class' => 'span8','value'=>0]);
                                  echo $form->field($model, 'sale_price')->textInput(['class' => 'span9','placeholder'=>'促销商品必需输入价格']);
                                echo $form->field($model, 'num')->textInput(['class' => 'span9','value'=>0]);
                                echo $form->field($model, 'is_on')->radioList(['下架', '上架'], ['class' => 'span8','value'=>1]);
                                echo $form->field($model, 'is_tui')->radioList(['不推荐', '推荐'], ['class' => 'span8','value'=>0]);
