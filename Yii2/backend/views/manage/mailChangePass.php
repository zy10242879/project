...
<!--  ⑭加入判断是否存在'info'信息 有则输出设置的返回结果-->
      ...
      <?=$form->field($model,'admin_user')->hiddenInput();?>
      <?=$form->field($model,'admin_pass')->passwordInput(['class'=>'span12','placeholder'=>'新密码']);?>
      ...
      <?=Html::submitButton('修改',['class'=>'btn-glow primary login']);?> <!--这里需要载入helps\Html-->
